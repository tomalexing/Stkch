...
var _sliderBox = require('./modules/slider-box');

var _sliderBox2 = _interopRequireDefault(_sliderBox);
...
function mail(form) {
	...
	$(form).on("submit", function (event) {
		...
		var $self = $(this);
		if (!(0, _validation.validation)($self.attr("id"))) {
...
},{"./validation":8}],3:[function(require,module,exports){
'use strict';
...
function animateMenu(menu, trigger_anchor, anchor_page, trigger_nenu) {
	var $menu = menu instanceof $ ? menu : $(menu);
	var $trigger_anchor = trigger_anchor instanceof $ ? trigger_anchor : $(trigger_anchor);
	var $links = $('' + menu + ' a[href^="#"]');
	var $anchorLeadToPage = $('' + menu + ' a[href^=' + anchor_page + ']');
	var $openMenuPage = trigger_nenu instanceof $ ? trigger_nenu : trigger_nenu === undefined ? $('[name=' + anchor_page.substring(1) + ']') : $('[name=' + trigger_nenu + ']');
	var $win = $(window);
...
SliderBox = (function() {
  ...
  SliderBox.prototype.init = function(selector, options) {
    ...
    this.sliderItem = this.el.find(this.props.sliderItem);
    this.duration = null;
    this.count = this.sliderItem.length;
    this.heightSlide = this.sliderItem.outerHeight();
    this.whichSlide = 1;
    this.prevSlide = 0;
    this._initSlider();
  ...
  SliderBox.prototype.makeFade = function() {
    if ((this.whichSlide - this.prevSlide) !== 0) {
      this.sliderTrack.css({
        'opacity': '0'
      });
      setTimeout((function(_this) {
        return function() {
          return _this.sliderTrack.css({
            'opacity': '1'
          });
        };
      })(this), 500);
    }
    return this.prevSlide = this.whichSlide;
  };
  ...
  SliderBox.prototype.scrollSlider = function(progress) {
    ...
    if (progress > .3 && progress < .6) {
      ...
      setTimeout((function(_this) {
        return function() {
          return _this.sliderTrack.css({
            '-webkit-transform': 'translate(0,' + (-1) * _this.heightSlide + 'px)',
            'transform': 'translate(0,' + (-1) * _this.heightSlide + 'px)'
          });
        };
      })(this), 250);
    }
    if (progress > .6) {
      ...
      return setTimeout((function(_this) {
        return function() {
          return _this.sliderTrack.css({
            '-webkit-transform': 'translate(0,' + (-1) * _this.heightSlide + 'px)',
            'transform': 'translate(0,' + (-2) * _this.heightSlide + 'px)'
          });
        };
      })(this), 250);
    }
  ...
  SliderBox.prototype._initSlider = function() {
    var paddingBottom, wrapperHeight;
    wrapperHeight = this.wrapper.outerHeight();
    paddingBottom = (this.count + 1) * this.heightSlide;
    this.wrapper.css({
      height: wrapperHeight,
      boxSizing: 'content-box',
      paddingBottom: paddingBottom
    });
    return this.duration = (this.count + 1) * this.heightSlide + 815;
  };
...
},{"./scroll-controller":6}],8:[function(require,module,exports){
'use strict';
